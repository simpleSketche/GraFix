...
def main(args):
	...
	# dataset, split
	d = VerticesAsNodeDataset(root=args.data_path, data_num=args.data_num)
	...
	model_args = {"input_dim": 2+GRAPH_BASED_FEATURE_DIM, "hidden_dim": args.hidden_dim, "output_dim": 1,
	...
	criterion = torch.nn.BCELoss() #MSELoss()
...
def parse_args() -> Namespace:
	...
	parser.add_argument(
		...
		default="./data/vertices_as_nodes/",
	)
	...
	parser.add_argument(
		...
		default="./Results/VerticesAsNode/",
	)
